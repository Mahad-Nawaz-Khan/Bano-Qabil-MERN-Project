...
import { addReservation } from "../services/reservationStorage.js";
...
export default function Reservation() {
  ...
  function handleSubmit(e) {
    ...
    try {
      const reservations = addReservation(null, "reservations", form);
      const last = reservations[reservations.length - 1];
      setMessage({
        text: `Reservation Confirmed! Your ID: ${last.id}. ${last.warning}`,
        show: true,
        error: false,
      });
      window.scrollTo({ top: 0, behavior: "smooth" });
